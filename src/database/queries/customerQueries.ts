...
export default class CustomerQueries {
     ...
     */
    createNewCustomer = (name: string, birthDate: string | undefined, bank: string, callback:
     ...
     */
    getCustomerByID = (customerID: string, callback:
        (error: Error | null, result?: any) => void) => {
     ...
     * error if one is thrown.
     */
    updateCustomer = (customerID: string, params: Map<string, string | number | undefined>, callback:
        (error: Error | null, result?: any) => void) => {
     ...
     * error if one is thrown.
     */
    deleteCustomer = (customerID: string, callback:
        (error: Error | null, result?: any) => void) => {
